...
size_t Sheet::GetNullCount(size_t row) {
    size_t null_count = 0;
...
size_t Sheet::GetEmptyRowsCount() {
    size_t zero_count = 0;
...
void Sheet::ClearCell(Position pos) {
    ...
    size_t del_count = GetNullCount(pos.row);
    ...
    size_t del_rows = GetEmptyRowsCount();
